...
const Home = () => {
                ...
                <div className="owl-stage-outer">
                  ...
                  >
                    <div className="owl-item cloned" style={{ width: "390px" }}>
                      <div className="col-md-12 teacher_col">
                ...
                <div className="slick-list draggable">
                  <div
                    ...
                    style={{
                      opacity: "1",
                      width: "9443px",
                      "-webkit-transform": "translate3d(-1349px, 0px, 0px)",
                      "-ms-transform": "translate3d(-1349px, 0px, 0px)",
                      transform: "translate3d(-1349px, 0px, 0px)",
                    }}
                  >
                    <div
                      className="tes-singel-content slick-slide slick-cloned"
                      data-slick-index={-1}
                      aria-hidden="true"
                      tabIndex={-1}
                      style={{ width: "1349px" }}
                    >
                      <div
                        className="testimonial-img col-lg-6 col-md-6 col-sm-12 col-xs-12"
                        style={{
                          "background-image":
                            "url(https://cdni.iconscout.com/illustration/premium/thumb/a-teacher-provides-feedback-to-students-8708615-7017381.png?f=webp)",
                        }}
                      />
                      <div className="testimonial-content-bl col-lg-6 col-md-6 col-sm-12 col-xs-12 ptb100">
                        ...
                        <div className="testimonial-bg inline-block ptb30 italic fsize-20">
                          <p className="mb10">
                            «Alcatra burgdoggen jerky landjaeger brisket ham
                            hock
                            <br /> ground round. Tongue ham hock boudin
                            meatloaf.
                          ...
                          <div className="testimonial-author table">
                            <div className="table-row">
                              ...
                              <div className="author-col table-cell valign-middle text-right">
                                <img
                                  src="assets/images/author-signature_3.png"
                                  alt
                    ...
                    <div
                      className="tes-singel-content slick-slide slick-current slick-active"
                      data-slick-index={0}
                      aria-hidden="false"
                      tabIndex={0}
                      role="tabpanel"
                    ...
                    >
                      ...
                      <div className="testimonial-content-bl col-lg-6 col-md-6 col-sm-12 col-xs-12 pt100 pb150">
                        <div className="testimonial-wrapper">
                          ...
                          <div className="testimonial-bg inline-block ptb30 italic fsize-20">
                            <p className="mb10">
                              "Turkey hamburger tongue, meatball chuck spare
                              ribs
                              <br /> burgdoggen picanha short ribs. Flank
                              prosciutto boudin
                            ...
                            <div className="testimonial-author table">
                              <div className="table-row">
                                ...
                                <div className="author-col table-cell valign-middle text-right">
                                  <img
                                    src="assets/images/author-signature_1.png"
                                    alt
                                    className="author-signature"
                                  />
                                </div>
                    ...
                    <div
                      className="tes-singel-content slick-slide"
                      data-slick-index={1}
                      aria-hidden="true"
                      tabIndex={-1}
                      role="tabpanel"
                        ...
                        <div className="testimonial-bg inline-block ptb30 italic fsize-20">
                          ...
                          <div className="testimonial-author table">
                            <div className="table-row">
                              ...
                              <div className="author-col table-cell valign-middle text-right">
                                <img
                                  src="assets/images/author-signature_2.png"
                                  alt
                                  className="author-signature"
                                />
                              </div>
                    ...
                    >
                      <div
                        ...
                        style={{
                          "background-image":
                            "url(assets/images/testimonials_1.jpg)",
                        }}
                      />
                      <div className="testimonial-content-bl col-lg-6 col-md-6 col-sm-12 col-xs-12 ptb100">
                        {/* title */}
  ...
  <div className="education-blog">
    <div className="container">
      <div className="row">
        <div className="text-center wow fadeIn" data-wow-duration="2s" style={{"visibility":"visible","-webkit-animation-duration":"2s","animation-duration":"2s","-webkit-animation-name":"_fadeIn","animation-name":"_fadeIn"}}>
          <div className="subtitle">
            A modern and unique style
          </div>
          <div className="title color-2 lheight-40 mb30">
            <span>Latest from blog<span className="color-15">.</span></span>
          </div>
          ...
          <div className="col-md-4 col-sm-6">
            <div className="single-blog-item">
              <div className="blog-photo">
                <img src="https://www.shutterstock.com/image-vector/blogging-blogger-freelance-creative-writing-260nw-1165873744.jpg" alt />
                <div className="blog-post-date theme-bg-gradient">
                  <h3 className="color-white fsize-16 plr30">23-9-2018</h3>
                </div>
                <div className="blog-dtls-link color-4">
                  <a href="#">Check Details <i className="fa fa-share" aria-hidden="true" /></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-4 col-sm-6">
            <div className="single-blog-item">
              <div className="blog-photo">
                ...
                <div className="blog-post-date theme-bg-gradient">
                  <h3 className="color-white fsize-16 plr30">25-9-2018</h3>
                </div>
                <div className="blog-dtls-link color-4">
                  <a href="#">Check Details <i className="fa fa-share" aria-hidden="true" /></a>
                </div>
          ...
          <div className="col-md-4 col-sm-6 col-md-offset-0 col-sm-offset-3">
            <div className="single-blog-item">
              <div className="blog-photo">
                <img src="assets/images/blog/blog-01.jpg" alt />
                <div className="blog-post-date theme-bg-gradient">
                  <h3 className="color-white fsize-16 plr30">26-9-2018</h3>
                </div>
                <div className="blog-dtls-link color-4">
                  <a href="#">Check Details <i className="fa fa-share" aria-hidden="true" /></a>
                </div>
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <div className="contact-section">
                  <form
                    method="post"
                    action="http://codestar.xyz/demo/education/assets/bin/mailer.php"
